    ...
    def __init__(self,
        ...
        **super_kwargs,         # Additional arguments for the Dataset base class.
        ...
        if os.path.isdir(self._path):
            self._type = 'dir'
            print("Listing files, this can take a while")
            self._all_fnames = find_all_files_recursively(self._path, progress=True, prepend_folder=True)
            print("End listing files")
